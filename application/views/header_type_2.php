...
<head>
    ...
    <script src="<?php echo base_url(); ?>public/script/jquery.validate.min.js" type="text/javascript"></script>
	...
	<header id="main-header" class="clearfix">
        <div id="header-full" class="clearfix">
            <div id="header" class="clearfix">
                ...
                <a href="#" id="logo"><img src="<?php echo base_url(); ?>public/images/logo.png" data-retina="<?php echo base_url(); ?>public/images/logo-retina.png" alt="logo" /></a>
