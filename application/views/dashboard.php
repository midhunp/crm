...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link href="<?php echo base_url(); ?>public/libs/ionicons/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Morris chart -->
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url(); ?>public/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
